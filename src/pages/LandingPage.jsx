  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <header className="bg-white border-b border-gray-100">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <h1 className="text-2xl font-bold text-blue-600">Waypoint</h1>
          </div>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 text-center">
        <img src="/logo.png" alt="Waypoint Intelligent Design DAEP" className="h-40 w-40 mx-auto mb-6 object-contain" />
        <h2 className="text-5xl font-bold text-gray-900 mb-4">
          Waypoint Intelligent Design DAEP
        </h2>
        ...
        <div className="flex justify-center gap-4">
          <Link to="/login" className="bg-blue-600 text-white px-8 py-3 rounded-lg font-medium hover:bg-blue-700 transition-colors text-lg">
            Get Started
          </Link>
      ...
      <footer className="bg-gray-900 text-gray-400 py-8">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center text-sm">
          <p>&copy; {new Date().getFullYear()} Waypoint Intelligent Design DAEP. All rights reserved.</p>
        </div>
      </footer>
    </div>
  )
